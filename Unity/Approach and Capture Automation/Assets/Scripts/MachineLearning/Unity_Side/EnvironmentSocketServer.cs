 ...
 *   - Changed script execution order to ensure this starts after the other monobehaviours have been initialised.
...
public class EnvironmentSocketServer : MonoBehaviour
{
    ...
    // Delay start to ensure EnvironmentController is ready for observation/action size query
    void Start() { StartCoroutine(OneFrameDelay(LateStart)); }
    private System.Collections.IEnumerator OneFrameDelay(Action callback) { yield return null; callback(); }
    private void LateStart()
    {
        // Validate EnvironmentController reference
        ...
        // Take initial obs/action sizes from EnvironmentController
